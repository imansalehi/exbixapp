                            ...
                            onTap: () {
                              ...
                              if (widget.fromKey == FromKey.buy && wallet.isDeposit == 1) {
                                if (wallet.currencyType == CurrencyType.crypto) {
                                  ...
                                  navigationTo(context, sFull: CurrencyWalletDepositScreen(wallet: wallet));
                                }
                              } else if (widget.fromKey == FromKey.sell && wallet.isWithdrawal == 1) {
                                if (wallet.currencyType == CurrencyType.crypto) {
                                  navigationTo(context, sFull: WalletWithdrawScreen(wallet: wallet));
                                } else if (wallet.currencyType == CurrencyType.fiat) {
                                  navigationTo(context, sFull: CurrencyWalletWithdrawalScreen(wallet: wallet));
                                }
                              }
                            },
                          );
