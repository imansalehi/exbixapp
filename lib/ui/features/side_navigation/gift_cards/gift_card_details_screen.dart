...
import 'package:exbix_flutter/ui/features/side_navigation/gift_cards/gift_cards_self/gift_cards_self_controller.dart';
          ...
          children: [
            ...
            Obx(() => redeemCode.value.isEmpty
                ? SizedBox(
                    ...
                    child: buttonText("See Code".tr, fontSize: Dimens.regularFontSizeExtraMid, onPress: () {
