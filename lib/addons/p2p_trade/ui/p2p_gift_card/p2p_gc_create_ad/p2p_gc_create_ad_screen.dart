...
import 'package:exbix_flutter/ui/features/side_navigation/gift_cards/gift_cards_widgets.dart';
            ...
            child: _controller.isLoading
                ...
                : ListView(
                    ...
                    children: [
                      ...
                      TextRobotoAutoNormal("Payment Type".tr, fontSize: Dimens.regularFontSizeMid),
                      Obx(() {
                      ...
                      Obx(() {
                        return _controller.selectedPaymentType.value == -1
                            ...
                            : Column(
                                ...
                                children: [
                                  vSpacer15(),
                                  TextRobotoAutoNormal("Currency Type".tr, fontSize: Dimens.regularFontSizeMid),
                      ...
                      vSpacer15(),
                      TextRobotoAutoNormal("Price".tr, fontSize: Dimens.regularFontSizeMid),
                      vSpacer5(),
                      ...
                      vSpacer15(),
                      TextRobotoAutoNormal("Status".tr, fontSize: Dimens.regularFontSizeMid),
                      Obx(() {
                      ...
                      Obx(() {
                        return _controller.selectedPaymentType.value == 0
                            ? Column(
                                ...
                                children: [
                                  vSpacer15(),
                                  TextRobotoAutoNormal("Payment Method".tr, fontSize: Dimens.regularFontSizeMid),
                                  vSpacer5(),
                      ...
                      vSpacer15(),
                      TextRobotoAutoNormal("Time Limit".tr, fontSize: Dimens.regularFontSizeMid),
                      Obx(() => dropDownListIndex(
                          ...
                          hMargin: 0, bgColor: Colors.transparent, radius: Dimens.radiusCornerMid)),
                      vSpacer15(),
                      TextRobotoAutoNormal("Terms And Conditions".tr, fontSize: Dimens.regularFontSizeMid),
                      vSpacer5(),
                      textFieldWithSuffixIcon(
                      ...
                      Row(
                        ...
                        children: [
                          buttonText("Cancel".tr,
                              bgColor: context.theme.dialogBackgroundColor, visualDensity: VisualDensity.compact, onPress: () => Get.back()),
                          hSpacer10(),
