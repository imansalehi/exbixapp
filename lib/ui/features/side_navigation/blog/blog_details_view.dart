...
import 'package:exbix_flutter/ui/features/side_navigation/blog/blog_screen.dart';
      ...
      return Expanded(
        child: ListView(
          ...
          children: [
            ...
            vSpacer10(),
            TextRobotoAutoBold(blog?.title ?? "", fontSize: Dimens.regularFontSizeLarge, maxLines: 3),
            vSpacer5(),
            Row(
