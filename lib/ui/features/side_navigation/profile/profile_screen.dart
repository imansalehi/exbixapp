      ...
      body: SafeArea(
        child: Obx(() => Column(
              children: [
                ...
                }, isScrollable: true, fontSize: Dimens.regularFontSizeMid),
                _buildBody()
              ],
            )),
      ),
        ...
        Row(
          children: [
            Container(
              ...
              decoration: getRoundCornerWithShadow(color: context.theme.dialogBackgroundColor),
            ...
            Column(
              ...
              children: [
                if (user.nickName.isValid) TextRobotoAutoBold(user.nickName ?? "", fontSize: Dimens.regularFontSizeLarge),
