...
class OpenCloseTabViewsState extends State<OpenCloseTabViews> with SingleTickerProviderStateMixin {
  ...
  _currencySwitchView(List<String> list) {
    final popView = Row(
      children: [
        TextRobotoAutoBold(" (${list[selectedSizeCoinIndex.value]})", fontSize: Dimens.regularFontSizeExtraMid),
    ...
    return FittedBox(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          children: [
            TextRobotoAutoBold("Size".tr, fontSize: Dimens.regularFontSizeMid, color: context.theme.primaryColorLight),
  ...
  _tpSLView(String tradeCoinType) {
    return Obx(() => Column(
          children: [
            vSpacer5(),
            Row(children: [
              ...
              TextRobotoAutoBold("TP/SL".tr, fontSize: Dimens.regularFontSizeSmall)
            ]),
            if (isTpSlOpen.value)
              Column(children: [
                vSpacer5(),
