  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          TextRobotoAutoBold(title, fontSize: Dimens.regularFontSizeMid, color: context.theme.primaryColorLight),
          vSpacer5(),
  ...
  Widget build(BuildContext context) {
    ...
    return SizedBox(
      ...
      child: Row(children: [
        ...
        hSpacer5(),
        Expanded(flex: 1, child: TextRobotoAutoBold(coin.coinType ?? "", fontSize: Dimens.regularFontSizeSmall)),
        hSpacer2(),
        Expanded(
          flex: 2,
          child: Column(
            ...
            children: [
              TextRobotoAutoNormal("${coin.currencySymbol ?? ""}${coinFormat(coin.usdtPrice, fixed: 2)}",
                  color: context.theme.primaryColor, fontSize: Dimens.regularFontSizeSmall, textAlign: TextAlign.end),
              TextRobotoAutoNormal(coinFormat(coin.change, fixed: 2),
                  color: getNumberColor(coin.change), fontSize: Dimens.regularFontSizeSmall, textAlign: TextAlign.end),
            ],
          ),
        )
      ]),
              ...
              children: [
                Row(
                  children: [
                    ...
                    if (coin.baseCoinType.isValid) TextRobotoAutoNormal("/${coin.baseCoinType}", fontSize: Dimens.regularFontSizeSmall),
                  ],
                ),
...
//                 crossAxisAlignment: CrossAxisAlignment.start,
//                 children: [
//                   TextRobotoAutoBold(coin.coinType ?? "", fontSize: Dimens.regularFontSizeExtraMid, maxLines: 2, textAlign: TextAlign.start),
