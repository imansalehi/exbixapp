      ...
      children: [
            ...
            child: Column(
              children: [
                Obx(() {
                  ...
                  return TotalBalanceViewSpot(gIsBalanceHide.value, total, onHistoryTap: () => Get.to(() => const ActivityScreen()));
                }),
                vSpacer10(),
        ...
        Row(
          children: [
            ...
            buttonOnlyIcon(iconData: Icons.refresh, visualDensity: minimumVisualDensity, onPress: () => initViewData())
          ],
        ),
        Obx(() {
...
class TotalBalanceViewSpot extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    String currencyName = getSettingsLocal()?.currency ?? total?.currency ?? DefaultValue.currency;
        ...
        Column(
          ...
          children: [
            ...
            isHide
                ...
                : TextRobotoAutoBold("${currencyFormat(total?.total)} $currencyName", fontSize: Dimens.regularFontSizeLarge),
          ],
        ),
        const Spacer(),
