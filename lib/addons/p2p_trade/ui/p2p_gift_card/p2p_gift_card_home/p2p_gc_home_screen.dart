...
import 'package:exbix_flutter/addons/p2p_trade/models/p2p_gift_card.dart';
import 'package:exbix_flutter/addons/p2p_trade/p2p_common_utils.dart';
                  ...
                  child: Wrap(
                    ...
                    children: List.generate(payments.length, (index) {
                      return Container(
                        ...
                        child: TextRobotoAutoBold(payments[index], fontSize: Dimens.regularFontSizeMin),
                      );
                    }),
                  ),
                ),
    ...
    return Expanded(
      child: ListView(
        ...
        children: [
          ...
          vSpacer15(),
          TextRobotoAutoNormal("Available Region".tr, fontSize: Dimens.regularFontSizeMid),
          Obx(() {
