...
class ReferralsScreenState extends State<ReferralsScreen> {
  ...
  _topShareView(String? referralLink) {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          vSpacer15(),
          Row(children: [
            ReferralsItemView(title: "${"Level".tr} ${keys[0]}", subtitle: values[0].toString(), subFontSize: Dimens.regularFontSizeLarge),
            ReferralsItemView(title: "${"Level".tr} ${keys[1]}", subtitle: values[1].toString(), subFontSize: Dimens.regularFontSizeLarge),
            ReferralsItemView(title: "${"Level".tr} ${keys[2]}", subtitle: values[2].toString(), subFontSize: Dimens.regularFontSizeLarge),
          ])
        ],
      ),
    );
...
class ReferencesView extends StatelessWidget {
  ...
  _referencesItemView(Referral referral) {
