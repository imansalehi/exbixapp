...
import 'package:exbix_flutter/ui/features/side_navigation/blog/blog_details_view.dart';
        ...
        flexibleSpace: Padding(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Text(settings.blogFeatureHeading ?? "",
                textAlign: TextAlign.start, style: context.textTheme.labelMedium!.copyWith(fontSize: Dimens.regularFontSizeMid), maxLines: 3),
            vSpacer5(),
        ...
        child: InkWell(
          ...
          child: Column(
            ...
            children: [
              ...
              vSpacer5(),
              TextRobotoAutoBold(blog.title ?? "", fontSize: Dimens.regularFontSizeLarge, maxLines: 2),
              vSpacer5(),
