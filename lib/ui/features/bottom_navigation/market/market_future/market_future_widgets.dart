            ...
            Row(
              children: [
                ...
                buttonText("24H Change".tr,
                    textColor: context.theme.focusColor, bgColor: context.theme.dialogBackgroundColor, visualDensity: VisualDensity.compact)
              ],
            )
          ],
        ),
    ...
    return InkWell(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            TextRobotoAutoBold(pair.getCoinPairName(), fontSize: Dimens.regularFontSizeSmall, color: context.theme.primaryColorLight),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            TextRobotoAutoBold(coinPair.getCoinPairName(), fontSize: Dimens.regularFontSizeSmall),
