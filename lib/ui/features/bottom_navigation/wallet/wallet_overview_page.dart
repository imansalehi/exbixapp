        ...
        return ListView(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                TextRobotoAutoNormal('Asset'.tr, fontSize: Dimens.regularFontSizeMid),
                TextRobotoAutoNormal('Available Balance'.tr, fontSize: Dimens.regularFontSizeMid)
              ],
            ),
            vSpacer5(),
            ...
            Expanded(
              ...
              child: Row(
                children: [
                  ...
                  hSpacer5(),
                  Expanded(child: TextRobotoAutoBold(name, fontSize: Dimens.regularFontSizeLarge, color: context.theme.primaryColorLight)),
                ],
              ),
            ),
            Expanded(
              ...
              child: isBalanceHide == true
                  ? const TextRobotoAutoBold("******", fontSize: Dimens.regularFontSizeMid)
                  : Column(
                      crossAxisAlignment: CrossAxisAlignment.end,
                      children: [
                        TextRobotoAutoBold("${coinFormat(amount)} $coinType", fontSize: Dimens.regularFontSizeMid),
          ...
          children: [
            ...
            Expanded(
              ...
              child: Column(
                ...
                children: [
                  TextRobotoAutoBold(title, fontSize: Dimens.regularFontSizeMid),
                  vSpacer5(),
            ...
            Expanded(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.end,
                children: [
                  TextRobotoAutoBold("$sign${coinFormat(history.amount)} $coinType", fontSize: Dimens.regularFontSizeMid),
                  vSpacer5(),
