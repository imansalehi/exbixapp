...
import 'package:exbix_flutter/ui/features/auth/change_password/change_password_screen.dart';
import 'package:exbix_flutter/ui/features/side_navigation/settings/settings_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView(
        ...
        children: [
          Align(alignment: Alignment.centerLeft, child: TextRobotoAutoNormal("Profile Security Status".tr, fontSize: Dimens.regularFontSizeExtraMid)),
          vSpacer10(),
          _basicSecurityView(),
          vSpacer20(),
          Align(alignment: Alignment.centerLeft, child: TextRobotoAutoNormal("Advanced Security".tr, fontSize: Dimens.regularFontSizeExtraMid)),
          vSpacer10(),
