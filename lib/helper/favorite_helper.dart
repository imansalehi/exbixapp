...
class FavoriteHelper {
  ...
  static updateFavorite(CoinPair pair, String fromKey, Function(CoinPair) onUpdate) {
  ...
  static checkFavorite(CoinPair pair, String fromKey, Function(CoinPair) onUpdate) {
    List<CoinPair> favList = getFavoriteList(fromKey);
  ...
  static showFavoritePopup(BuildContext context, Offset offset, CoinPair pair, String? fromKey, Function(String?)? onFavChange) async {
