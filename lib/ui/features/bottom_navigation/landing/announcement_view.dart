  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: CarouselSlider.builder(
          ...
          options: CarouselOptions(viewportFraction: 1, height: height, autoPlay: true, autoPlayInterval: const Duration(seconds: 10))),
    );
  }
}
              ...
              children: [
                    ...
                    : Expanded(
                        child: Text.rich(
                          TextSpan(
                            text: textList[0],
                            style:
                                context.theme.textTheme.labelMedium?.copyWith(fontSize: Dimens.titleFontSizeSmall, color: context.theme.focusColor),
                            children: <TextSpan>[
                              TextSpan(text: text.substring(textList[0].length, text.length), style: context.theme.textTheme.labelMedium),
                            ],
                          ),
                          maxLines: 4,
                ...
                ClipRRect(
                    ...
                    child: showImageNetwork(
                        imagePath: banner.image ?? "", width: imageSize, height: imageSize, boxFit: BoxFit.contain, bgColor: Colors.transparent)),
              ],
            ),
            vSpacer10(),
            Row(
              mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: [
                buttonOnlyIcon(iconData: Icons.east, visualDensity: VisualDensity.compact, iconColor: context.theme.primaryColorLight),
                Container(
                  ...
                  child: Text.rich(
                    TextSpan(
                      ...
                      children: <TextSpan>[
                        TextSpan(text: "/$total", style: Get.theme.textTheme.labelMedium!.copyWith(color: context.theme.primaryColorLight)),
                      ],
                    ),
                  ),
                ),
