...
import 'package:exbix_flutter/ui/features/side_navigation/gift_cards/gift_card_details_screen.dart';
import 'package:exbix_flutter/ui/features/side_navigation/gift_cards/gift_cards_controller.dart';
          ...
          children: [
            ...
            Padding(
                ...
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextRobotoAutoBold(gCard.banner?.title ?? "", fontSize: Dimens.regularFontSizeExtraMid, maxLines: 2),
                    TextRobotoAutoNormal(gCard.banner?.subTitle ?? "", fontSize: Dimens.regularFontSizeSmall, maxLines: 2)
                  ],
                )),
          ],
        ),
