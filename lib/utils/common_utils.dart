  ...
  if (text.isValid) {
    ...
    if (context != null) {
      Widget toast = Container(
          ...
          child: TextRobotoAutoNormal(text!, color: isError ? Colors.white : Theme.of(context).secondaryHeaderColor, maxLines: 10));
...
void navigationTo(BuildContext context, {StatefulWidget? sFull, bool removeCurrent = false, StatelessWidget? sLess, Function(dynamic)? onResult}) async {
  dynamic result;
  if (removeCurrent) {
