    ...
    child: Column(
      ...
      children: [
        ...
        TextRobotoAutoNormal(description,
            fontSize: Dimens.regularFontSizeMid, maxLines: 50, color: Get.theme.primaryColor),
        vSpacer10(),
      ],
    ),
  );
        ...
        subtitle: Padding(
          ...
          child: Row(
            ...
            children: [
              ...
              buttonText(btnTitle, bgColor: feedback.feedbackType == 1 ? Colors.green : Colors.redAccent, visualDensity: minimumVisualDensity)
            ],
          ),
        ),
      ),
...
class SegmentedControlView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final fontSize = isTextScaleGetterThanOne(context) ? Dimens.regularFontSizeSmall : Dimens.regularFontSizeMid;
                        ...
                        child: Row(
                          ...
                          return Container(
                            decoration: BoxDecoration(
                                borderRadius: const BorderRadius.all(Radius.circular(20.0)), color: context.theme.focusColor.withOpacity(0.25)),
