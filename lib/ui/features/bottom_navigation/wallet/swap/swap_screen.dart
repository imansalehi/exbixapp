              ...
              children: [
                          ...
                          Row(
                            children: [
                              ...
                              buttonText("Max".tr,
                                  ...
                                  onPress: () => _controller.fromEditController.text = coinFormat(fCoin.balance ?? fCoin.availableBalance)),
                ...
                InkWell(
                  ...
                  child: Container(
                    ...
                    child: Container(
                      decoration: boxDecorationRoundCorner(radius: Dimens.radiusCornerLarge, color: context.theme.dialogBackgroundColor),
                      padding: const EdgeInsets.all(Dimens.paddingMin),
