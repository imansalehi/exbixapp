...
import 'package:exbix_flutter/addons/p2p_trade/ui/p2p_home/p2p_home_controller.dart';
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            vSpacer5(),
            TwoTextSpaceFixed("${"Price".tr} : ", "${coinFormat(p2pAds.price)} ${p2pAds.currency ?? ""}", fontSize: Dimens.regularFontSizeSmall),
            TwoTextSpaceFixed("${"Available".tr} : ", "${coinFormat(p2pAds.available)} ${p2pAds.coinType ?? ""}",
                fontSize: Dimens.regularFontSizeSmall),
            TwoTextSpaceFixed("${"Limit".tr} : ", limitSrt, fontSize: Dimens.regularFontSizeSmall),
            if (p2pAds.paymentMethodList.isValid)
              Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  TextRobotoAutoBold("${"Payment".tr} : ", color: context.theme.primaryColorLight, fontSize: Dimens.regularFontSizeSmall),
                  Expanded(
                    child: Wrap(
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: ListView(
        padding: const EdgeInsets.all(Dimens.paddingMid),
        children: [
          TextRobotoAutoNormal("Limit Amount".tr, fontSize: Dimens.regularFontSizeMid),
          vSpacer5(),
          ...
          vSpacer15(),
          TextRobotoAutoNormal("Fiat".tr, fontSize: Dimens.regularFontSizeMid),
          Obx(() {
          ...
          vSpacer15(),
          TextRobotoAutoNormal("Payment".tr, fontSize: Dimens.regularFontSizeMid),
          Obx(() {
          ...
          vSpacer15(),
          TextRobotoAutoNormal("Available Regions".tr, fontSize: Dimens.regularFontSizeMid),
          Obx(() {
...
class P2pTutorialView extends StatelessWidget {
          ...
          Wrap(
            ...
            children: List.generate(settings.paymentMethodLanding?.length ?? 0, (index) {
              return Container(
                ...
                child: TextRobotoAutoBold(settings.paymentMethodLanding![index].name ?? "", fontSize: Dimens.regularFontSizeExtraMid),
              );
            }),
          ),
          vSpacer10(),
  ...
  _tutorialItemView(String? imagePath, String? title, String? subTitle) {
    return ListTile(
      ...
      subtitle: TextRobotoAutoNormal(subTitle ?? "", fontSize: Dimens.regularFontSizeSmall, maxLines: 100),
    );
  }
}
