  ...
  return Directionality(
    ...
    child: ElevatedButton.icon(
        ...
        style: ButtonStyle(
            ...
            visualDensity: visualDensity,
            padding: MaterialStateProperty.all<EdgeInsetsGeometry>(padding ?? const EdgeInsets.symmetric(horizontal: 10, vertical: 0)),
            foregroundColor: MaterialStateProperty.all<Color>(bgColor),
            backgroundColor: MaterialStateProperty.all<Color>(bgColor),
...
Widget buttonText(String text,
  ...
  bgColor = bgColor ?? Get.theme.focusColor;
  fontSize = fontSize ?? (visualDensity == minimumVisualDensity ? Dimens.regularFontSizeExtraMid : null);
  textColor = textColor ?? (bgColor == Get.theme.focusColor ? Colors.white : null);
...
buttonTextBordered(String text, bool selected, {VoidCallback? onPress, Color? color, VisualDensity? visualDensity, double? radius}) {
