...
import 'package:exbix_flutter/addons/p2p_trade/models/p2p_order.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Flexible(
      child: ListView(
        ...
        padding: const EdgeInsets.all(Dimens.paddingMid),
        children: [
          TextRobotoAutoNormal("Coin".tr, fontSize: Dimens.regularFontSizeMid),
          Obx(() {
          ...
          vSpacer15(),
          TextRobotoAutoNormal("Order Type".tr, fontSize: Dimens.regularFontSizeMid),
          Obx(() {
            ...
            children: [
              Expanded(
                child: Column(
                  ...
                  children: [
                    TextRobotoAutoNormal("From".tr, fontSize: Dimens.regularFontSizeMid),
                    vSpacer5(),
              ...
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    TextRobotoAutoNormal("To".tr, fontSize: Dimens.regularFontSizeMid),
                    vSpacer5(),
            ...
            children: [
              Expanded(
                  child: currentText.isNotEmpty
                      ...
                      : const TextRobotoAutoNormal(dateFormatMMDdYyyy, fontSize: Dimens.regularFontSizeExtraMid)),
