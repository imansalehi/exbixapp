...
class P2pAddPaymentPage extends StatefulWidget {
  const P2pAddPaymentPage({super.key, this.paymentInfo});
  ...
  Widget build(BuildContext context) {
    return Expanded(
      child: ListView(
        ...
        children: [
          if (widget.paymentInfo == null)
            Obx(() => dropDownListIndex(getPaymentNameList(), selectedPayment.value, "Select Payment Method".tr, (index) {
          ...
          vSpacer20(),
          buttonRoundedMain(text: "Confirm".tr, onPress: () => checkAndSaveBank())
        ],
      ),
    );
  }
