...
import 'package:exbix_flutter/data/models/kyc_details.dart';
...
import 'package:exbix_flutter/utils/persona_util.dart';
...
class _KYCScreenState extends State<KYCScreen> {
  ...
  _manualVerificationView(KycDetails details) {
    return Column(children: [
      Align(alignment: Alignment.centerLeft, child: TextRobotoAutoNormal("KYC Verification List".tr, fontSize: Dimens.regularFontSizeExtraMid)),
  ...
  Widget _kycItemView(KycObject? kyc, String title, String imagePath) {
    return Column(
      children: [
                  ...
                  child: Stack(
                    children: [
                      ...
                      Container(
                          ...
                          height: Dimens.iconSizeMid,
                          width: context.width / 2.5,
                          child: TextRobotoAutoNormal(getIdVerificationStatus(kyc?.status), color: Colors.white))
                    ],
                  ),
                ),
        ...
        TextRobotoAutoNormal(title, fontSize: Dimens.regularFontSizeExtraMid, textAlign: TextAlign.center)
      ],
    );
  }
